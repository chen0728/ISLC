...
module.exports = function (app) {
    ...
    router.post("/upload", function (req, res, next) {
        ...
        form.maxFieldsSize = 512 * 1024 * 1024;   //�ļ���С
        ...
        form.parse(req, function(err, fields, files) {
            ...
            debugger;
            var extName =files.Filedata.name.split(".")[files.Filedata.name.split(".").length-1];  //��׺��.
            var avatarName = uuid.v1() + '.' + extName;
            var newPath = form.uploadDir + avatarName;

            console.log(newPath);
            fs.renameSync(files.Filedata.path, newPath);  //������
