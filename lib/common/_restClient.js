...
var systemBearerToken = require(process.cwd() + '/lib/common/config').systemBearerToken;
...
var RestClient = function (options) {
    ...
    var baseUrl = options.baseUrl || 'http://127.0.0.1';
    var client = new Client(options);

    function setDefaultArgs(args) {
        args = args || {};
        args.headers = args.headers || {};
        args.headers['Content-Type'] = args.headers['Content-Type'] || 'application/json; charset=utf-8';
        var authorizationAddedFlag = false;
